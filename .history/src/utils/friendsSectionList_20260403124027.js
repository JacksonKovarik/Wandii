    ...
    <View style={{ flex: 1 }}>
      ...
      <SectionList
        ...
        contentContainerStyle={{
          ...
          paddingRight: scale(30), // space for index
        }}
      ...
      {/* RIGHT-SIDE INDEX */}
      <View style={styles.rightIndexContainer}>
        {ALPHABET.map((letter, index) => (
          <Pressable
            ...
            onResponderMove={(e) => {
              ...
              const letterIndex = Math.floor(touchY / 14);
              const draggedLetter = ALPHABET[letterIndex];
              if (draggedLetter) {
                setActiveLetter(draggedLetter);
                scrollToLetter(draggedLetter, false);
              }
            }}
            style={[
