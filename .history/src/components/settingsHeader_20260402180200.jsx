...
export default function SettingsHeader({ title, photo, initials, onPickImage }) {
  ...
  return (
    <View style={styles.headerContainer}>
      ...
      {/* cancel above title, same horizontal alignment */}
      ...
      {/* title row with slight right shift */}
      <View style={styles.titleRow}>
        <View style={{ width: 70 }} />   {/* slightly wider left spacer */}

        <Text style={styles.title}>{title}</Text>

        <View style={{ width: 60 }} />   {/* original right spacer */}
      </View>
