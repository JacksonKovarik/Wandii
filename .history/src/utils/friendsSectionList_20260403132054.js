  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <SectionList
        ...
        stickySectionHeadersEnabled={true}   // <-- FIXED
...
const styles = StyleSheet.create({
  ...
  /* GRAY SECTION HEADERS — FIXED FOR STICKY BEHAVIOR */
  sectionHeader: {
    fontSize: moderateScale(18),
    fontWeight: "700",
    paddingTop: verticalScale(20),     // <-- FIXED
    paddingBottom: verticalScale(6),   // <-- FIXED
    color: "#CCCCCC",
    backgroundColor: "#FFFFFF",        // <-- REQUIRED for sticky headers
  },
