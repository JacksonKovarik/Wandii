...
export default function FriendsSectionList({ sections }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {/* TRACKING BAR (FULL WIDTH, BLOCKS CONTENT BELOW) */}
      ...
      <SectionList
        ...
        contentContainerStyle={{
          paddingTop: verticalScale(26),   // <-- pushes list BELOW tracking bar
...
const styles = StyleSheet.create({
  ...
  /* TRACKING BAR (FULL WIDTH) */
  trackingBar: {
    height: verticalScale(26),
    justifyContent: "center",
    paddingLeft: scale(10),
    backgroundColor: "#FFFFFF",   // solid background so nothing shows behind it
    borderBottomWidth: 1,
