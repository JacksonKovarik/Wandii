...
export default function Stays() {
  ...
  const StayCard = ({ stay }) => {
    return (
      <View style={{ width: '100%', backgroundColor: '#ffffff', borderRadius: 20, marginBottom: 15, overflow: 'hidden' }}>
        <ImageBackground source={ require("@/assets/images/Kyoto.jpg") } style={{ height: 140 }} />
        <View style={{ paddingVertical: 20, paddingHorizontal: 15 }}>
          <Text style={{ fontSize: moderateScale(16), fontWeight: '600', color: Colors.darkBlue, marginBottom: 5 }}>{stay.name}</Text>
          ...
          <View style={{ width: '100%', flexDirection: 'row', gap: 5, marginBottom: 10, backgroundColor: Colors.lightGray, padding: 10, borderRadius: 4, alignSelf: 'flex-start', alignItems: 'center', marginTop: 10 }}>
            ...
            <TouchableOpacity style={{ marginLeft: 'auto' }} onPress={() => console.log('Copy address')} hitSlop={5}>
          ...
          <TouchableOpacity style={{ width: '100%', flexDirection: 'row', paddingVertical: 10, backgroundColor: Colors.darkBlue, alignItems: 'center', justifyContent: 'center', gap: 10, borderRadius: 10, alignSelf: 'center', marginTop: 20}} onPress={() => console.log('Get directions')}>
