...
export default function FriendsSectionList({ sections }) {
  ...
  const LETTER_HEIGHT = 12; // more compact
...
const styles = StyleSheet.create({
  ...
  hiddenHeader: {
    opacity: 0, // hides gray header when stuck
  },
  ...
  rightIndexContainer: {
    position: "absolute",
    right: scale(6),
    top: verticalScale(40), // moved down so it never overlaps tracking bar
  ...
  letterRow: {
    height: verticalScale(12), // more compact
    justifyContent: "center",
    alignItems: "center",
  },
