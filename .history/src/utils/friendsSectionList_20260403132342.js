...
export default function FriendsSectionList({ sections }) {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      {/* ORANGE TRACKING LETTER UNDER SEARCH BAR */}
      ...
      <SectionList
        ...
        stickySectionHeadersEnabled={false}   // keep original behavior
        onViewableItemsChanged={onViewableItemsChanged}
        viewabilityConfig={{ itemVisiblePercentThreshold: 10 }}
        contentContainerStyle={{
          paddingTop: verticalScale(30),   // <-- pushes avatars BELOW tracking letter
